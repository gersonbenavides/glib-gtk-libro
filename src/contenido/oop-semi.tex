...
\lstinputlisting[float, caption={myapp-spell-checker.h}, label=oop-semi-spell-checker-h]{codigo/myapp-spell-checker.h}
...
%PARA HACER explicar new() (asignación en el montón) vs init() (asignación en la pila) y dar un ejemplo con init(). Pero el ejemplo también requiere el código *.c, por lo que quizás sea mejor agregar la explicación en una subsección posterior.
...
\vspace{0.7cm}
\lstinputlisting[caption={myapp-spell-checker.c}, label=oop-semi-spell-checker-c]{codigo/myapp-spell-checker.c}
