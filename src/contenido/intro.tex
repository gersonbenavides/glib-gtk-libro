...
Advertencia: este “libro” está lejos de estar terminado, estás leyendo la versión~\bookversion. Si tiene algún comentario, no dude en ponerse en contacto con el autor en swilmet@gnome.org o con el traductor en gmbsdeveloper@gmail.com, ¡gracias!
...
\begin{center}
    \includegraphics[height=0.8cm]{imagenes/creative-commons.pdf}
\end{center}
...
La guía se publica como un documento Free/\emph{Libre} y es gratuita. Pero no se materializa en un espacio vacío; se necesita tiempo para escribir. Al donar, demuestras tu aprecio por este trabajo y ayudas a su desarrollo futuro.
...
\section{Separación de backend del frontend}
